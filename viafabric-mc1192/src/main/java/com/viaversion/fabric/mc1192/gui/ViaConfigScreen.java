...
public class ViaConfigScreen extends Screen implements AbstractViaConfigScreen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(calculatePosX(this.width, entries), calculatePosY(this.height, entries), 150, 20, getClientSideText(), this::onClickClientSide));
        entries++;

        this.addDrawableChild(new ButtonWidget(calculatePosX(this.width, entries), calculatePosY(this.height, entries), 150, 20, getHideViaButtonText(), this::onHideViaButton));
        entries++;
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, this.height - 40, 200, 20, ScreenTexts.DONE, (it) -> close()));
    }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawCenteredTextWithShadow(matrices, this.textRenderer, this.title.asOrderedText(), this.width / 2, 20, 16777215);
